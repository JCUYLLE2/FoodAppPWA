...
function App() {
  ...
  return (
    <Router>
      ...
      <Routes>
        {/* Redirect naar de feed als de gebruiker is ingelogd */}
        ...
        <Route path="/logout" element={user ? <LogoutPage /> : <Navigate to="/" replace />} />
        <Route path="/create-post" element={user ? <PostPage /> : <Navigate to="/" replace />} />
      </Routes>
